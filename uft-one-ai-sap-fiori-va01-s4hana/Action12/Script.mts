...
AIUtil.SetContext Browser("creationtime:=0")
Set OutboundDeliveryMessage = AIRegex("Outbound Delivery \d+ was saved and distributed to the WMS View Details")
...
Reporter.ReportEvent micDone, "Delivery Number", "The Delivery Number from the popup window is " & DeliveryMessageArray(2) & "."
